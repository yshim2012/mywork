...
namespace DataMapper
{
    ...
    public class BaseEntity<T>
    {
        ...
        public static T QueryObject(object primaryKey)
        {
            ...
            else { return QueryObject(sqlmapper, primaryKey); }
        }
        ...
        public static T QueryObject(string statement, object primaryKey)
		{
            ...
            else { return QueryObject(sqlmapper, statement, primaryKey); }
		}
        ...
        public virtual IList<T> QueryList()
        {
            ...
            else { return QueryList(sqlmapper); }
        }
        ...
        public virtual IList<T> QueryList(string statement)
        {
            ...
            else { return QueryList(sqlmapper, statement); }
        }
        ...
        public static DataTable QueryPageing(IDictionary paramhashmap, int skipResults, int maxResults)
        {
            ...
            using (IDalSession session = sqlmapper.OpenConnection())
            {
                return sqlmapper.QueryForPageing(statement, paramhashmap, skipResults, maxResults, "Table");
            }
        }
        ...
        public static DataTable QueryPageing(IDictionary paramhashmap, int skipResults, int maxResults, out long rowcount)
        {
            try
            {
                ...
                using (IDalSession session = sqlmapper.OpenConnection())
                {
                    DataTable datatable = sqlmapper.QueryForPageing(statement, paramhashmap, skipResults, maxResults, "Table");
        ...
        public virtual object Save(ISqlMapper sqlmapper, string statement, Object param)
        {
            statement = String.Format("{0}.{1}", typeof(T).Name, statement);
            object result = null;
            if (SelectKey())
            {
                result = sqlmapper.Insert(statement, param);
            }
            else
            {
                sqlmapper.Insert(statement, param);
            }
            return result;
        }
#endregion
