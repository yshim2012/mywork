...
namespace WY.Library.Model
{
	...
	/// 路线发布 (数据持久层对象)
	/// </summary>
	[ActiveRecord("TB_RoutePublish")]
	public class TBRoutePublish : BaseModel
	{
		private int _id;
		/// <summary>
		/// ID
		...
		private int _route_shift_id;
		/// <summary>
		/// 班次路线ID
		/// </summary>
		[Property()]
		public int Route_shift_id
		{
			get { return this._route_shift_id; }
			set { this._route_shift_id = value; }
		}
